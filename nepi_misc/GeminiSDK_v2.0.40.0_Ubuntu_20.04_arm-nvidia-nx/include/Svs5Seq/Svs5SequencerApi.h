...
Parameters:
    ...
    restartMode         Allows the Start/Stop cycle of the SVS5 library

Returns:                Svs5ErrorCode
****************************************/
AFX_EXT_SVS5_SEQUENCER_INTERFACE Svs5ErrorCode StartSvs5( Svs5Callback fnSvs5, bool restartMode = false );
